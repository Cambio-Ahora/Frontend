...
export default {
  ...
  */
  head: {
    ...
    script: [
     // { src: 'https://cdn.jsdelivr.net/npm/uikit@3.3.0/dist/js/uikit.min.js' }
    ]
  },
  /*
  ...
  */
  plugins: [{ src: '~/plugins/vue-check-view', ssr: false },{ src: '~/plugins/uikit', ssr: false }, { src: '~/plugins/onload', ssr: false }],
  /*
  ** Nuxt.js dev-modules
  */
  buildModules: [
